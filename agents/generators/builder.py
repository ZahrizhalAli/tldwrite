...
from agents.generators import badges, tables, tree
from agents.generators.emojis import ThemeManager
from agents.generators.enums import BadgeStyles
from agents.generators.headers import HeaderRegistry, HeaderTemplate
from agents.generators.navigation import NavigationTemplate
from agents.generators.quickstart import QuickStartBuilder
from agents.retrievers.git.providers import GitHost
...
class MarkdownBuilder:
    ...
    def quickstart_guide(self) -> str:
        ...
        _logger.info(f"Quickstart (agents.generators): {content}")
        for section in [
            "Prerequisites",
            "Installation",
            "Usage",
